...
export function StoreFooter() {
  return <footer className="footer">
    ...
    <div className="footer-top">
      ...
      <div><h4>Conecte-se</h4><a href={`https://wa.me/${settings.whatsapp}`} target="_blank" rel="noreferrer">WhatsApp <ArrowUpRight size={15} /></a><a href="#">Instagram <ArrowUpRight size={15} /></a></div>
    </div>
