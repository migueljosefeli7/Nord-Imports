...
function fallback(): StoreSnapshot { return { products: fallbackProducts, brands: fallbackBrands, categories: fallbackCategories, settings: fallbackSettings, configured: false }; }
function unavailable(error: string): StoreSnapshot { return { products: [], brands: [], categories: [], settings: fallbackSettings, configured: false, error }; }
